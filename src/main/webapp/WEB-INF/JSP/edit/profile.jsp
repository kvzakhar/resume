...
<div class="panel panel-default edit-profile">
	<div class="panel-body">
		...
		<form:form modelAttribute="profileForm" action="/edit?${_csrf.parameterName}=${_csrf.token}" method="post" cssClass="form-horizontal data-form" enctype="multipart/form-data">
			...
			<div class="form-group ${hasError ? 'has-error' : ''}">
				...
				<div class="col-sm-5">
					<form:input path="country" class="form-control" id="inputCountry" placeholder="Example: Russia" required="required" />
			...
			<div class="form-group ${hasError ? 'has-error' : ''}">
				...
				<div class="col-sm-5">
					<form:input path="city" class="form-control" id="inputCity" placeholder="Example: Moscow" required="required" />
			...
			<div class="form-group ${hasError ? 'has-error' : ''}">
				...
				<div class="col-sm-5">
					<form:input path="email" type="email" class="form-control" id="inputEmail" placeholder="Example: richard.hendricks@gmail.com" required="required" />
